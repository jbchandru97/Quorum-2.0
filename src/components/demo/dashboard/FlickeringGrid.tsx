...
export const FlickeringGrid: React.FC<FlickeringGridProps> = ({
  ...
  // Start as true so animation fires immediately on mount — IntersectionObserver
  // still pauses it if it scrolls off-screen, but we don't want a blank first frame.
  const [isInView,  setIsInView]  = useState(true);
  const [canvasSize, setCanvasSize] = useState({ width: 0, height: 0 });

  // Parse any CSS color into an "rgba(r,g,b," prefix once
